...
struct Material {
	Material(Color ambient, Color diffuse, Color specular, double exp, double refractionCoeff) :
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp), refractionCoeff(refractionCoeff), hasTexture(false) {}
